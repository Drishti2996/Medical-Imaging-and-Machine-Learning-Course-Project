...
num_gpu1 = torch.cuda.device_count()
...
# PREPROCESSING STAGE: crop the images 
...
# PREPROCESSING STAGE: flip the images 
...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(tqdm(train_loader)):
            ...
            preds_1 = torch.BoolTensor(sig_out.cpu() > 0.5)
            ...
            tqdm.write(f"Epoch {epoch+1}/{10}, Batch {i+1}/{len(train_loader)}, Loss: {loss:.4f}")
    ...
    # saving the model to use in correlation loss class
